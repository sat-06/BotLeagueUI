const sponsors = [
  'NEXT OLIVE', 'ROBO IT', 'REGAIN NT', 'MTI SOLAR',
  'BTI', 'NIT BOKHAR', 'NIT SACHAR', 'ROBO MINDS', 'ROBO WHALE',
];
    ...
    <section className="py-16 bg-[#070707] border-t border-[#111]">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-5 opacity-50">
          {sponsors.map((s, i) => (
            <span key={i} className="text-gray-400 font-extrabold text-xs uppercase tracking-wider hover:opacity-100 transition-opacity">
              {s}
            </span>
          ))}
        </div>
